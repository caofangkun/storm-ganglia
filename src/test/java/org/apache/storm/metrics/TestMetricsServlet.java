...
import org.apache.storm.metrics.MetricsServlet;
import org.apache.storm.metrics.MetricsServlet.TagsMetricsPair;
import org.apache.storm.metrics.spi.NoEmitMetricsContext;
...
public class TestMetricsServlet extends TestCase {
  ...
  /**
   * Initializes, for testing, two NoEmitMetricsContext's, and adds one value to
   * the first of them.
   */
  ...
  public void testTagsMetricsPair() throws IOException {
    TagsMetricsPair pair =
        new TagsMetricsPair(outputRecord.getTagsCopy(),
  ...
  public void testGetMap() throws IOException {
    ...
    assertEquals("Wrong number of tags-values pairs.", 1, m2.get("testRecord")
        .size());
  }
