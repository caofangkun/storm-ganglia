...
public class MetricsTimeVaryingRate extends MetricsBase {
  ...
  private static final Logger LOG = LoggerFactory
      .getLogger(MetricsTimeVaryingRate.class);
   ...
   */
  public MetricsTimeVaryingRate(final String nam,
  ...
  private synchronized void intervalHeartBeat() {
    ...
    previousIntervalData.time =
        (currentData.numOperations == 0) ? 0 : currentData.time
            / currentData.numOperations;
    currentData.reset();
  }
