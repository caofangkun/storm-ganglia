...
/**
 * 
 * This is the registry for metrics. Related set of metrics should be declared
 * in a holding class and registered in a registry for those metrics which is
 * also stored in the the holding class.
 * 
 */
public class MetricsRegistry {
  private Map<String, MetricsBase> metricsList =
   ...
   */
  public synchronized void add(final String metricsName,
      final MetricsBase theMetricsObj) {
