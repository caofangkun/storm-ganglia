...
public class WorkerActivtyMBean extends MetricsDynamicMBeanBase {
  final private ObjectName mbeanName;

  protected WorkerActivtyMBean(MetricsRegistry mr) {
    super(mr, "Activity statistics at the Worker");
    mbeanName = MBeanUtil.registerMBean("Worker", "WorkerActivity", this);
  }
