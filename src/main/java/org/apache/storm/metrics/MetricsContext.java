...
public interface MetricsContext {
  ...
  /**
   * Stops monitoring and also frees any buffered data, returning this object to
   * its initial state.
   */
   ...
   * fixed set of record names and <code>recordName</code> is not in that set.
   * 
  ...
  /**
   * Registers a callback to be called at regular time intervals, as determined
   * by the implementation-class specific configuration.
   * 
   * @param updater object to be run periodically; it should updated some
   *          metrics records and then return
   */
