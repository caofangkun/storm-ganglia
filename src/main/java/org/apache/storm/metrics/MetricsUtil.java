 ...
 * 
 * @see org.apache.storm.metrics.MetricsRecord
 * @see org.apache.storm.metrics.MetricsContext
 * @see org.apache.storm.metrics.ContextFactory
 */
public class MetricsUtil {
  ...
  /**
   * Returns the host name. If the host name is unobtainable, logs the exception
   * and returns "unknown".
   */
