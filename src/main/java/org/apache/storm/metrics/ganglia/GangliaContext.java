...
import org.apache.storm.metrics.spi.AbstractMetricsContext;
import org.apache.storm.metrics.spi.OutputRecord;
import org.apache.storm.metrics.spi.Util;
...
public class GangliaContext extends AbstractMetricsContext {
  ...
  private static final Map<Class, String> typeTable =
      new HashMap<Class, String>(5);
  static {
   ...
   */
  protected void xdr_string(String s) throws IOException {
